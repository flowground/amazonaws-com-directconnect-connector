# ![LOGO](logo.png) AWS Direct Connect MSP Connector

## Description

A generated MSP connector for the AWS Direct Connect API (version 2012-10-25).
...
flowground :- Telekom iPaaS / amazonaws-com-directconnect-connector<br/>
